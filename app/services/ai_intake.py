...
- need의 title 작성 규칙: 반드시 사용자가 말한 구체적인 내용과 표현을 최대한 살려야 한다. 의미를 요약하거나 추상화하지 말 것. NPC가 있으면 그 NPC 캐릭터가 주인공에게 직접 말하는 게임 대사 스타일로 작성 (예: npc=엄마, 입력="엄마가 보고싶다" → "보고 싶었어, 우리 아이. 엄마도 네 생각 많이 했어."). NPC가 없으면 주인공이 자신의 목소리로 욕구를 직접 말하는 스타일로 작성 — 감정의 온도에 맞게 열정적일 수도 잔잔할 수도 있으며, 원문의 구체적 표현을 그대로 담을 것 (예: 입력="더 성장하고 싶고 멋진 결과물을 만들고 싶은 사람들이 가득한 환경에서 일하고 싶어" → "더 성장하고 싶어. 멋진 결과물을 만들고 싶은 사람들이 가득한 환경에서 일하고 싶어!", 입력="그냥 쉬고 싶다 오늘" → "지금은 그냥 쉬고 싶어. 충분히 달려왔잖아.")"""
